...
public class RunnerBuilder {
  ...
  public RunnerBuilder
  natManagerServiceName(final String natManagerServiceName) {
    this.natManagerServiceName = natManagerServiceName;
    return this;
  }

  public RunnerBuilder
  natMethodFallbackEnabled(final boolean natMethodFallbackEnabled) {
  ...
  public Runner build() {
    ...
    final PeerPermissionsDenylist bannedNodes =
        PeerPermissionsDenylist.create();
    ...
    final boolean fallbackEnabled =
        natMethod == NatMethod.AUTO || natMethodFallbackEnabled;
    final NatService natService =
        new NatService(buildNatManager(natMethod), fallbackEnabled);
    ...
    if (miningParameters.isStratumMiningEnabled()) {
      stratumServer = Optional.of(new StratumServer(
          vertx, miningCoordinator, miningParameters.getStratumPort(),
    ...
    if (graphQLConfiguration.isEnabled()) {
      ...
      final GraphQLDataFetcherContextImpl dataFetcherContext =
          new GraphQLDataFetcherContextImpl(blockchainQueries, protocolSchedule,
  ...
  private Map<String, JsonRpcMethod> jsonRpcMethods(
    ...
    final Map<String, JsonRpcMethod> methods =
        new JsonRpcMethodsFactory().methods(
            ...
            supportedCapabilities, accountAllowlistController,
            nodeAllowlistController, jsonRpcApis, privacyParameters,
            jsonRpcConfiguration, webSocketConfiguration, metricsConfiguration,
