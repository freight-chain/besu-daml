...
public class BesuCommand implements DefaultCommandValues, Runnable {
  ...
  @CommandLine.Option(
      hidden = true, names = {"--Xws-timeout-seconds"},
      description = "Web socket timeout in seconds (default: ${DEFAULT-VALUE})",
      arity = "1")
  private final Long wsTimeoutSec =
      TimeoutOptions.defaultOptions().getTimeoutSeconds();
  ...
  private void validateNatParams() {
    if (!(natMethod.equals(NatMethod.AUTO) ||
          natMethod.equals(NatMethod.KUBERNETES)) &&
  ...
  private void issueOptionWarnings() {
    ...
    CommandLineUtils.checkOptionDependencies(
        ...
        asList("--miner-coinbase", "--min-gas-price",
               ...
               "--miner-stratum-enabled", "--Xminer-remote-sealers-limit",
  ...
  private BesuCommand configure() throws Exception {
    ...
    permissioningConfiguration
        ...
        .ifPresent(
            p
            -> ensureAllNodesAreInAllowlist(staticNodes.stream()
                                                .map(EnodeURL::toURI)
                                                .collect(Collectors.toList()),
                                            p));
  ...
  private Optional<PermissioningConfiguration> permissioningConfiguration()
    ...
    if (permissionsNodesContractEnabled) {
      if (permissionsNodesContractAddress == null) {
        ...
        smartContractPermissioningConfiguration
            .setSmartContractNodeAllowlistEnabled(
