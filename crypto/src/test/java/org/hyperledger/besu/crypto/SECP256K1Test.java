...
public class SECP256K1Test {
  ...
  public static String suiteName() { return suiteName; }
  ...
  public void privateKeyEquals() {
    final SECP256K1.PrivateKey privateKey1 =
        SECP256K1.PrivateKey.create(BigInteger.TEN);
    final SECP256K1.PrivateKey privateKey2 =
        SECP256K1.PrivateKey.create(BigInteger.TEN);
  ...
  public void publicKeyEquals() {
    final SECP256K1
        .PublicKey publicKey1 = SECP256K1.PublicKey.create(fromHexString(
    ...
    final SECP256K1
        .PublicKey publicKey2 = SECP256K1.PublicKey.create(fromHexString(
        "a0434d9e47f3c86235477c7b1ae6ae5d3442d49b1943c2b752a68e2a47e247c7893aba425419bc27a3b6c7e693a24c696f794c2ed877a1593cbee53b037368d7"));
  ...
  public void publicHashCode() {
    final SECP256K1
        .PublicKey publicKey = SECP256K1.PublicKey.create(fromHexString(
        "a0434d9e47f3c86235477c7b1ae6ae5d3442d49b1943c2b752a68e2a47e247c7893aba425419bc27a3b6c7e693a24c696f794c2ed877a1593cbee53b037368d7"));
  ...
  public void createKeyPair_PublicKeyNull() {
    new SECP256K1.KeyPair(null,
                          SECP256K1.PublicKey.create(Bytes.wrap(new byte[64])));
  }

  @Test(expected = NullPointerException.class)
  public void createKeyPair_PrivateKeyNull() {
    new SECP256K1.KeyPair(
        SECP256K1.PrivateKey.create(Bytes32.wrap(new byte[32])), null);
  }
  ...
  public void keyPairEquals() {
    ...
    final SECP256K1.KeyPair keyPair1 =
        new SECP256K1.KeyPair(privateKey1, publicKey1);
    final SECP256K1.KeyPair keyPair2 =
        new SECP256K1.KeyPair(privateKey2, publicKey2);
  ...
  public void publicKeyRecovery() {
    final SECP256K1.PrivateKey privateKey =
        SECP256K1.PrivateKey.create(BigInteger.TEN);
    final SECP256K1
        .PublicKey expectedPublicKey = SECP256K1.PublicKey.create(fromHexString(
        "a0434d9e47f3c86235477c7b1ae6ae5d3442d49b1943c2b752a68e2a47e247c7893aba425419bc27a3b6c7e693a24c696f794c2ed877a1593cbee53b037368d7"));
  ...
  public void recoverPublicKeyFromSignature() {
    final SECP256K1.PrivateKey privateKey =
        SECP256K1.PrivateKey.create(new BigInteger(
            "c85ef7d79691fe79573b1a7064c19c1a9819ebdbd1faaab1a8ec92344438aaf4",
            16));
    final SECP256K1.KeyPair keyPair = SECP256K1.KeyPair.create(privateKey);

    final Bytes data =
        Bytes.wrap("This is an example of a signed message.".getBytes(UTF_8));
    ...
    assertThat(recoveredPublicKey.toString())
        .isEqualTo(keyPair.getPublicKey().toString());
  }
  ...
  public void signatureGeneration() {
    ...
    final Bytes data =
        Bytes.wrap("This is an example of a signed message.".getBytes(UTF_8));
    final Bytes32 dataHash = keccak256(data);
    final SECP256K1.Signature expectedSignature = SECP256K1.Signature.create(
        new BigInteger(
    ...
    final SECP256K1.Signature actualSignature =
        SECP256K1.sign(dataHash, keyPair);
  ...
  public void signatureVerification() {
    ...
    final SECP256K1.Signature signature = SECP256K1.sign(dataHash, keyPair);
    assertThat(SECP256K1.verify(data, signature, keyPair.getPublicKey(),
                                Hash::keccak256))
        .isTrue();
  }
  ...
  public void readWritePrivateKeyString() throws Exception {
    ...
    final File tempFile =
        Files.createTempFile(suiteName(), ".keypair").toFile();
