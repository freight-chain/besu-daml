...
public enum GraphQLError {
  ...
  TRANSACTION_UPFRONT_COST_EXCEEDS_BALANCE(
      -32004, "Upfront cost exceeds account balance"),
  EXCEEDS_BLOCK_GAS_LIMIT(-32005,
  ...
  CHAIN_HEAD_WORLD_STATE_NOT_AVAILABLE(-32008,
  ...
  public static GraphQLError
  of(final TransactionInvalidReason transactionInvalidReason) {
