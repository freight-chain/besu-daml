...
public class PrivGetLogs implements JsonRpcMethod {
  ...
  public PrivGetLogs(final BlockchainQueries blockchainQueries,
  ...
  public JsonRpcResponse response(final JsonRpcRequestContext request) {
    ...
    if (filter.getBlockhash() != null) {
      return new JsonRpcSuccessResponse(
          ...
          new LogsResult(privacyQueries.matchingLogs(
              privacyGroupId, filter.getBlockhash(), query)));
    }
    ...
    return new JsonRpcSuccessResponse(
        request.getRequest().getId(),
        new LogsResult(privacyQueries.matchingLogs(
            privacyGroupId, fromBlockNumber, toBlockNumber, query)));
  }
