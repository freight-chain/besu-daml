...
public class EthGetBlockByHash implements JsonRpcMethod {
  ...
  public EthGetBlockByHash(final BlockchainQueries blockchain,
                           final BlockResultFactory blockResult) {
    this(Suppliers.ofInstance(blockchain), blockResult);
  }

  public EthGetBlockByHash(final Supplier<BlockchainQueries> blockchain,
                           final BlockResultFactory blockResult) {
  ...
  private boolean
  isCompleteTransactions(final JsonRpcRequestContext requestContext) {
