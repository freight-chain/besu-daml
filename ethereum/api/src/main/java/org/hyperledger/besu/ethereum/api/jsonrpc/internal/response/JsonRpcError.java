...
public enum JsonRpcError {
  ...
  ACCOUNT_WHITELIST_NOT_ENABLED(-32000,
                                "Account whitelisting has not been enabled"),
  ACCOUNT_WHITELIST_EMPTY_ENTRY(-32000,
                                "Request contains an empty list of accounts"),
  ACCOUNT_WHITELIST_INVALID_ENTRY(-32000,
                                  "Request contains an invalid account"),
  ACCOUNT_WHITELIST_DUPLICATED_ENTRY(-32000,
                                     "Request contains duplicate accounts"),
  ACCOUNT_WHITELIST_EXISTING_ENTRY(
      -32000, "Cannot add an existing account to whitelist"),
  ACCOUNT_WHITELIST_ABSENT_ENTRY(
      -32000, "Cannot remove an absent account from whitelist"),
  ...
  NODE_WHITELIST_EXISTING_ENTRY(-32000,
                                "Cannot add an existing node to whitelist"),
  NODE_WHITELIST_MISSING_ENTRY(-32000,
                               "Cannot remove an absent node from whitelist"),
  NODE_WHITELIST_FIXED_NODE_CANNOT_BE_REMOVED(
      -32000,
      "Cannot remove a fixed node (bootnode or static node) from whitelist"),

  // Permissioning/persistence errors
  WHITELIST_PERSIST_FAILURE(
      -32000,
      "Unable to persist changes to whitelist configuration file. Changes reverted"),
  WHITELIST_FILE_SYNC(
      -32000,
  ...
  PERMISSIONING_NOT_ENABLED(-32000,
                            "Node/Account whitelisting has not been enabled"),
  ...
  FIND_ON_CHAIN_PRIVACY_GROUP_ERROR(-50100,
                                    "Error finding on-chain privacy group"),
  ...
  ONCCHAIN_PRIVACY_GROUP_DOES_NOT_EXIST(
      -50100, "Onchain Privacy group does not exist."),
  ...
  PRIVACY_GROUP_ID_NOT_AVAILABLE(
      -50100,
      "Privacy group id is not available while OnChain privacy groups are enabled"),
