...
public class PrivGetPrivateTransactionIntegrationTest {
  ...
  private final PrivateStateStorage privateStateStorage =
      mock(PrivateStateStorage.class);
  ...
  private final PrivateTransaction privateTransaction =
      PrivateTransaction.builder()
          ...
          .privateFor(Lists.newArrayList(Bytes.wrap(
              "A1aVtMxLCUHmBVHXoZzzBgPbW/wj5axDpW9X8l91SGo=".getBytes(UTF_8))))
  ...
  public void returnsStoredPrivateTransaction() {
    ...
    final String payload =
        Base64.getEncoder().encodeToString(bvrlp.encoded().toArrayUnsafe());
    final ArrayList<String> to =
        Lists.newArrayList("A1aVtMxLCUHmBVHXoZzzBgPbW/wj5axDpW9X8l91SGo=");
    final SendResponse sendResponse =
        enclave.send(payload, ENCLAVE_PUBLIC_KEY, to);
