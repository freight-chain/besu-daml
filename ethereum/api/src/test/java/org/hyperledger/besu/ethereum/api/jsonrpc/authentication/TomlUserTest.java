...
public class TomlUserTest {
  ...
  public void createsPrincipleWithAllValues() {
    final TomlUser tomlUser = new TomlUser(
        "user", "password", list("admin"), list("eth:*", "perm:*"), list("net"),
    ...
    assertThat(principal.getJsonArray("groups"))
        .isEqualTo(new JsonArray(list("admin")));
    assertThat(principal.getJsonArray("permissions"))
        .isEqualTo(new JsonArray(list("eth:*", "perm:*")));
    assertThat(principal.getJsonArray("roles"))
        .isEqualTo(new JsonArray(list("net")));
  ...
  public void createsPrincipalWithOnlyRequiredValues() {
    final TomlUser tomlUser = new TomlUser("user", "password", list(), list(),
                                           list(), Optional.empty());
