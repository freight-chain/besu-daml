...
public class EthSubscribeIntegrationTest {
  ...
  public void before() {
    ...
    webSocketRequestHandler = new WebSocketRequestHandler(
        vertx, webSocketMethodsFactory.methods(),
  ...
  public void shouldAddConnectionToMap(final TestContext context) {
    ...
    final JsonRpcRequest subscribeRequestBody =
        createEthSubscribeRequestBody(CONNECTION_ID_1);

    vertx.eventBus()
        .consumer(CONNECTION_ID_1)
        .handler(msg -> {
          final List<SyncingSubscription> syncingSubscriptions =
              getSubscriptions();
        ...
        .completionHandler(
            ...
            -> webSocketRequestHandler.handle(
                CONNECTION_ID_1, Json.encode(subscribeRequestBody)));
  ...
  public void shouldAddMultipleConnectionsToMap(final TestContext context) {
    ...
    final JsonRpcRequest subscribeRequestBody1 =
        createEthSubscribeRequestBody(CONNECTION_ID_1);
    final JsonRpcRequest subscribeRequestBody2 =
        createEthSubscribeRequestBody(CONNECTION_ID_2);
    ...
    vertx.eventBus()
        ...
        .handler(msg -> {
          ...
          vertx.eventBus()
              ...
              .handler(msg2 -> {
                final List<SyncingSubscription> updatedSubscriptions =
                    getSubscriptions();
                ...
                assertThat(connectionIds)
                    .containsExactlyInAnyOrder(CONNECTION_ID_1,
                                               CONNECTION_ID_2);
                async.countDown();
              })
              .completionHandler(
  ...
  private List<SyncingSubscription> getSubscriptions() {
    return subscriptionManager.subscriptionsOfType(SubscriptionType.SYNCING,
                                                   SyncingSubscription.class);
  }

  private WebSocketRpcRequest
  createEthSubscribeRequestBody(final String connectionId) {
