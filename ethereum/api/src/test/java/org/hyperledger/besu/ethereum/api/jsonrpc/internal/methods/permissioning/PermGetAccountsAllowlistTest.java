...
public class PermGetAccountsAllowlistTest {
  ...
  private static final JsonRpcRequestContext request =
      new JsonRpcRequestContext(
          new JsonRpcRequest("2.0", "perm_getAccountsAllowlist", null));
  ...
  public void before() {
    method =
        new PermGetAccountsAllowlist(java.util.Optional.of(accountAllowlist));
  }
  ...
  public void shouldReturnExpectedListOfAccountsWhenAllowlistHasBeenSet() {
    ...
    JsonRpcResponse expectedResponse =
        new JsonRpcSuccessResponse(null, accountsList);
  ...
  @Test
  public void
  shouldReturnEmptyListOfAccountsWhenAllowlistHasBeenSetAndIsEmpty() {
    List<String> emptyAccountsList = new ArrayList<>();
    when(accountAllowlist.getAccountAllowlist()).thenReturn(emptyAccountsList);
    JsonRpcResponse expectedResponse =
        new JsonRpcSuccessResponse(null, emptyAccountsList);
