...
public class TransactionPoolTest {
  ...
  shouldDiscardRemoteTransactionThatAlreadyExistsBeforeValidation() {
    ...
    final TransactionPool transactionPool = new TransactionPool(
        ...
        Optional.empty(), TransactionPoolConfiguration.DEFAULT);
  ...
  @Test
  public void
  shouldAllowTransactionWhenAccountAllowlistControllerIsNotPresent() {
    givenTransactionIsValid(transaction1);
  ...
  public void shouldIgnoreFeeCapIfSetZero() {
    ...
    when(transactionValidator.validateForSender(
             ...
             any(TransactionValidationParams.class)))
        .thenReturn(valid());
    assertThat(transactionPool
                   .addLocalTransaction(new TransactionTestFixture()
                                            .nonce(1)
  ...
  public void shouldRejectLocalTransactionIfFeeCapExceeded() {
    ...
    final TransactionTestFixture builder = new TransactionTestFixture();
    final Transaction transactionLocal = builder.nonce(1)
                                             .gasPrice(twoEthers.add(Wei.of(1)))
                                             .createTransaction(KEY_PAIR1);
    ...
    assertThat(result.getInvalidReason())
        .isEqualTo(TransactionInvalidReason.TX_FEECAP_EXCEEDED);
  }
