...
public interface PeerValidator {
  ...
  /**
   * If the peer cannot currently be validated, returns a timeout indicating how
   * long to wait. before trying to validate the peer again.
   *
   * @param ethPeer The peer to be validated.
   * @return A duration representing how long to wait before trying to validate
   *     this peer again.
   */
   ...
   */
  CompletableFuture<Boolean> validatePeer(final EthContext ethContext,
