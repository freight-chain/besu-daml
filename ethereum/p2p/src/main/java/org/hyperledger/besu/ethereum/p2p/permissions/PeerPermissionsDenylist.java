...
public class PeerPermissionsDenylist extends PeerPermissions {
  ...
  private PeerPermissionsDenylist(final int initialCapacity,
                                  final OptionalInt maxSize) {
    if (maxSize.isPresent()) {
      blacklist = LimitedSet.create(initialCapacity, maxSize.getAsInt(),
                                    Mode.DROP_LEAST_RECENTLY_ACCESSED);
    } else {
