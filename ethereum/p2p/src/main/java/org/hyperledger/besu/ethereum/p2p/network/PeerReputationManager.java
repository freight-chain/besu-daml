...
public class PeerReputationManager implements DisconnectCallback {
  private static final Set<DisconnectReason> locallyTriggeredDisconnectReasons =
      ImmutableSet.of(DisconnectReason.BREACH_OF_PROTOCOL,
                      DisconnectReason.INCOMPATIBLE_P2P_PROTOCOL_VERSION);

  private static final Set<DisconnectReason>
      remotelyTriggeredDisconnectReasons =
  ...
  @Override
  public void onDisconnect(final PeerConnection connection,
  ...
  private boolean shouldBlock(final DisconnectReason reason,
                              final boolean initiatedByPeer) {
