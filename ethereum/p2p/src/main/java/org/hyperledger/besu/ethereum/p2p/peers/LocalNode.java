...
public interface LocalNode {
  ...
  static LocalNode create(final String clientId, final int p2pVersion,
   ...
   * @throws NodeNotReadyException If the local node is not ready, throws an
   *     exception.
   */
  ...
  /**
   * This method can be called prior to invoking any method that may throw a
   * {@link NodeNotReadyException}. If this method returns true, the node is
   * ready and will not throw an exception.
   *
  ...
  class NodeNotReadyException extends RuntimeException {
    public NodeNotReadyException(final String message) { super(message); }
  }
}
