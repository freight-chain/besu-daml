...
/**
 * A particular quantity of difficulty, the block difficulty to create new
 * blocks.
 */
public final class Difficulty
    extends BaseUInt256Value<Difficulty> implements Quantity {
  ...
  Difficulty(final UInt256 value) { super(value, Difficulty::new); }

  private Difficulty(final long v) { this(UInt256.valueOf(v)); }

  private Difficulty(final BigInteger v) { this(UInt256.valueOf(v)); }
