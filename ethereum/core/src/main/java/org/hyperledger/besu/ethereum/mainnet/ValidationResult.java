...
public final class ValidationResult<T> {
  ...
  private ValidationResult(final Optional<T> invalidReason,
                           final Optional<String> errorMessage) {
    this.invalidReason = invalidReason;
    this.errorMessage = errorMessage;
  }

  public boolean isValid() { return invalidReason.isEmpty(); }
  ...
  public <R> R either(final Supplier<R> whenValid,
                      final Function<T, R> whenInvalid) {
  ...
  public static <T> ValidationResult<T> invalid(final T reason,
    ...
    return new ValidationResult<>(Optional.of(reason),
