...
public class FeeMarketConfig implements FeeMarket {
  ...
  public FeeMarketConfig(final long basefeeMaxChangeDenominator,
                         final long targetGasUsed, final long maxGas,
                         final long decayRange, final long gasIncrementAmount,
                         final long initialBasefee, final long perTxGaslimit) {
