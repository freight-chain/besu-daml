...
public class MiningParameters {
  ...
  public static final long DEFAULT_REMOTE_SEALERS_TTL =
  ...
  public MiningParameters(final Address coinbase,
                          final Wei minTransactionGasPrice,
                          final Bytes extraData, final boolean enabled) {
    this(coinbase, minTransactionGasPrice, extraData, enabled, false, "0.0.0.0",
         8008, "080c", Optional.empty(), 0.8, DEFAULT_REMOTE_SEALERS_LIMIT,
  ...
  public MiningParameters(final Address coinbase,
                          ...
                          final int stratumPort, final String stratumExtranonce,
  ...
  public Optional<Address> getCoinbase() { return coinbase; }

  public Wei getMinTransactionGasPrice() { return minTransactionGasPrice; }

  public Bytes getExtraData() { return extraData; }

  public boolean isMiningEnabled() { return enabled; }

  public boolean isStratumMiningEnabled() { return stratumMiningEnabled; }

  public String getStratumNetworkInterface() { return stratumNetworkInterface; }

  public int getStratumPort() { return stratumPort; }

  public String getStratumExtranonce() { return stratumExtranonce; }

  public Optional<Iterable<Long>> getNonceGenerator() {
    return maybeNonceGenerator;
  }

  public Double getMinBlockOccupancyRatio() { return minBlockOccupancyRatio; }

  public int getRemoteSealersLimit() { return remoteSealersLimit; }

  public long getRemoteSealersTimeToLive() { return remoteSealersTimeToLive; }
  ...
  public int hashCode() {
    return Objects.hash(coinbase, minTransactionGasPrice, extraData, enabled,
                        ...
                        stratumPort, stratumExtranonce, minBlockOccupancyRatio,
                        remoteSealersLimit, remoteSealersTimeToLive);
  }
  ...
  public String toString() {
    return "MiningParameters{"
        ...
        ", extraData=" + extraData + ", enabled=" + enabled +
        ", stratumMiningEnabled=" + stratumMiningEnabled +
        ", stratumNetworkInterface='" + stratumNetworkInterface + '\'' +
        ", stratumPort=" + stratumPort + ", stratumExtranonce='" +
        stratumExtranonce + '\'' +
        ", maybeNonceGenerator=" + maybeNonceGenerator +
