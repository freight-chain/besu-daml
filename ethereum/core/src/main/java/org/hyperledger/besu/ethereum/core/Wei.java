...
public final class Wei extends BaseUInt256Value<Wei> implements Quantity {
  ...
  Wei(final UInt256 value) { super(value, Wei::new); }

  private Wei(final long v) { this(UInt256.valueOf(v)); }

  private Wei(final BigInteger v) { this(UInt256.valueOf(v)); }
  ...
  public static Wei fromHexString(final String str) { return new Wei(str); }
