...
public abstract class PrivateMarkerTransactionFactory {
  ...
  protected PrivateMarkerTransactionFactory(
  ...
  public Transaction create(final String transactionEnclaveKey,
                            final PrivateTransaction privateTransaction) {
    return create(transactionEnclaveKey, privateTransaction,
                  privacyPrecompileAddress);
  }

  public abstract Transaction
  create(final String transactionEnclaveKey,
         final PrivateTransaction privateTransaction,
         final Address precompileAddress);

  protected Transaction create(final String transactionEnclaveKey,
                               final PrivateTransaction privateTransaction,
                               final long nonce, final KeyPair signingKey) {
