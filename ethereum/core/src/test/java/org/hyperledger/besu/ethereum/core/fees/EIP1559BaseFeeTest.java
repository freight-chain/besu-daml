...
public class EIP1559BaseFeeTest {
  ...
  public static Collection<Object[]> data() {
    return Arrays.asList(new Object[][] {
        {FEE_MARKET.getInitialBasefee(), FEE_MARKET.getTargetGasUsed(),
  ...
  public EIP1559BaseFeeTest(final long parentBaseFee, final long parentGasUsed,
  ...
  public void assertThatBaseFeeIsCorrect() {
    assertThat(eip1559.computeBaseFee(parentBaseFee, parentGasUsed))
