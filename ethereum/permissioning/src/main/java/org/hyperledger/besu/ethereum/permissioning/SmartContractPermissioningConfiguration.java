...
public class SmartContractPermissioningConfiguration {
  ...
  public void
  setNodeSmartContractAddress(final Address nodeSmartContractAddress) {
  ...
  public void setSmartContractAccountAllowlistEnabled(
    ...
    this.smartContractAccountAllowlistEnabled =
        smartContractAccountAllowlistEnabled;
  }
  ...
  public void
  setAccountSmartContractAddress(final Address accountSmartContractAddress) {
