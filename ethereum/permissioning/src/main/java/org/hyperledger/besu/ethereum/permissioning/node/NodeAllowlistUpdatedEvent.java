...
public class NodeAllowlistUpdatedEvent {
  ...
  public NodeAllowlistUpdatedEvent(final List<EnodeURL> addedNodes,
                                   final List<EnodeURL> removedNodes) {
    this.addedNodes = addedNodes != null ? addedNodes : Collections.emptyList();
    this.removedNodes =
        removedNodes != null ? removedNodes : Collections.emptyList();
  }

  public List<EnodeURL> getAddedNodes() { return addedNodes; }

  public List<EnodeURL> getRemovedNodes() { return removedNodes; }
