...
public class AccountPermissioningControllerFactoryTest {
  ...
  public void createWithNullPermissioningConfigShouldReturnEmpty() {
    Optional<AccountPermissioningController> controller =
        AccountPermissioningControllerFactory.create(null, transactionSimulator,
                                                     metricsSystem);
  ...
  @Test
  public void
  createLocalConfigWithAccountPermissioningDisabledShouldReturnEmpty() {
    LocalPermissioningConfiguration localConfig =
  ...
  public void createLocalConfigOnlyControllerShouldReturnExpectedController() {
    ...
    assertThat(controller.get().getAccountLocalConfigPermissioningController())
        .isNotEmpty();
    assertThat(
        controller.get().getTransactionSmartContractPermissioningController())
        .isEmpty();
  }

  @Test
  public void
  createOnchainConfigWithAccountPermissioningDisabledShouldReturnEmpty() {
  ...
  @Test
  public void
  createOnchainConfigOnlyControllerShouldReturnExpectedController() {
  ...
  private SmartContractPermissioningConfiguration onchainConfig() {
    ...
    onchainPermissioningConfiguration.setSmartContractAccountAllowlistEnabled(
        true);
