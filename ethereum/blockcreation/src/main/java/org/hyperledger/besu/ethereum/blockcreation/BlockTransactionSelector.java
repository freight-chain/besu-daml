...
public class BlockTransactionSelector {
  ...
  public static class TransactionSelectionResults {
    ...
    public long getCumulativeGasUsed() { return cumulativeGasUsed; }
  }
  ...
  public BlockTransactionSelector(
      ...
      final MainnetBlockProcessor
          .TransactionReceiptFactory transactionReceiptFactory,
      final Wei minTransactionGasPrice, final Supplier<Boolean> isCancelled,
  ...
  private boolean transactionTooLargeForBlock(final Transaction transaction) {
    final long blockGasRemaining =
        ...
        transactionSelectionResult.getCumulativeGasUsed();
