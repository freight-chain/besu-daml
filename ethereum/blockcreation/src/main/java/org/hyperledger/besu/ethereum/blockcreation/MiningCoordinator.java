...
public interface MiningCoordinator {
  ...
  default Optional<Long> hashesPerSecond() { return Optional.empty(); }
   ...
   * @return If supported, returns the block that was created, otherwise an
   *     empty response.
   */
  Optional<Block> createBlock(final BlockHeader parentHeader,
