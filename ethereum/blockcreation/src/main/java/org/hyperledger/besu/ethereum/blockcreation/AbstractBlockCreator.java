...
public abstract class AbstractBlockCreator<C> implements AsyncBlockCreator {
  ...
  selectTransactions(final ProcessableBlockHeader processableBlockHeader,
    ...
    final BlockTransactionSelector selector = new BlockTransactionSelector(
        ...
        transactionReceiptFactory, minTransactionGasPrice, isCancelled::get,
        miningBeneficiary, protocolSpec.getTransactionPriceCalculator(),
        ()
  ...
  createPendingBlockHeader(final long timestamp) {
    ...
    final DifficultyCalculator<C> difficultyCalculator =
        protocolSchedule.getByBlockNumber(newBlockNumber)
