...
public class EthHashMiningCoordinatorTest {
  ...
  public void reportedHashRateIsCachedIfNoCurrentDataInMiner() {
    ...
    when(miner.getHashesPerSecond())
        .thenReturn(hashRate1, hashRate2, hashRate3);

    when(executor.startAsyncMining(any(), any(), any()))
        .thenReturn(Optional.of(miner));
