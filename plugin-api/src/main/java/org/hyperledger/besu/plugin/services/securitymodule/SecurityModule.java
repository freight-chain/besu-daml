...
/**
 * Provides a generic interface for classes which wrap/hide a cryptographic
 * private key. This interface ensures cryptographic functions required by
 * Ethereum are available to the application at large, without releasing the
...
public interface SecurityModule {
   ...
   * @return the signature (R, S) generated by signing the hash with the node
   *     key
   ...
   *
   * @return the public key associated with the key stored behind this
   *     interface.
