...
public class AccountLocalConfigPermissioningAcceptanceTest
  ...
  public void setUp() throws Exception {
    ...
    node = permissionedNodeBuilder.name("node")
  ...
  private void verifyTransferForbidden(final Account sender,
