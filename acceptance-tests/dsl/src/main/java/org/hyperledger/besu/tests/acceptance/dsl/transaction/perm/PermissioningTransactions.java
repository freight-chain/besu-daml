...
public class PermissioningTransactions {
  ...
  addAccountsToAllowlist(final String... accounts) {
    return new PermAddAccountsToWhitelistTransaction(Arrays.asList(accounts));
  }

  public PermRemoveAccountsFromWhitelistTransaction
  removeAccountsFromAllowlist(final String... accounts) {
    return new PermRemoveAccountsFromWhitelistTransaction(
  ...
  public PermRemoveNodeTransaction
  removeNodesFromAllowlist(final List<URI> enodeList) {
  ...
  public LoginSuccessfulTransaction
  createSuccessfulLogin(final String username, final String password) {
