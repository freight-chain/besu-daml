...
public class PrivacyInterface extends Contract {
  ...
  @Deprecated
  protected PrivacyInterface(String contractAddress, Web3j web3j,
  ...
  @Deprecated
  public static PrivacyInterface
  load(String contractAddress, Web3j web3j, Credentials credentials,
       BigInteger gasPrice, BigInteger gasLimit) {
    return new PrivacyInterface(contractAddress, web3j, credentials, gasPrice,
                                gasLimit);
  }

  @Deprecated
  public static PrivacyInterface load(String contractAddress, Web3j web3j,
                                      TransactionManager transactionManager,
                                      BigInteger gasPrice,
                                      BigInteger gasLimit) {
    return new PrivacyInterface(contractAddress, web3j, transactionManager,
                                gasPrice, gasLimit);
  }
  ...
  public static PrivacyInterface load(String contractAddress, Web3j web3j,
                                      Credentials credentials,
                                      ContractGasProvider contractGasProvider) {
    return new PrivacyInterface(contractAddress, web3j, credentials,
                                contractGasProvider);
  }
  ...
  public static RemoteCall<PrivacyInterface>
  deploy(Web3j web3j, Credentials credentials,
         ContractGasProvider contractGasProvider) {
    return deployRemoteCall(PrivacyInterface.class, web3j, credentials,
  ...
  deploy(Web3j web3j, TransactionManager transactionManager,
         ContractGasProvider contractGasProvider) {
    return deployRemoteCall(PrivacyInterface.class, web3j, transactionManager,
                            contractGasProvider, BINARY, "");
  }
