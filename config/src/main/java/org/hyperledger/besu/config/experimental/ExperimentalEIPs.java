...
/**
 * Flags defined in those class must be used with cautious, and strictly
 * reserved to experimental EIPs.
 */
public class ExperimentalEIPs {
  ...
  @Option(
      hidden = true, names = {"--Xeip1559-enabled"},
      description =
          "Enable experimental EIP-1559 fee market change (default: ${DEFAULT-VALUE})",
      arity = "1")
  ...
  @Option(
      hidden = true, names = {"--Xberlin-enabled"},
      description =
          "Enable non-finalized Berlin features (default: ${DEFAULT-VALUE})",
      arity = "1")
  ...
  public static void eip1559MustBeEnabled() {
    if (!eip1559Enabled) {
      throw new RuntimeException(
          "EIP-1559 feature flag must be enabled --Xeip1559-enabled");
    }
  }
}
